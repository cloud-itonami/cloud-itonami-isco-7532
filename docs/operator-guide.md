...
2. Define consent and purpose categories for cutter/workshop records.
...
- safety-critical escalation path (cutting-tool hazard,
  material-handling hazard, equipment condition)
- provenance for all operating records (cutter and workshop both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  pattern-cutting-execution decision, a workshop-safety-clearance
