...
`cloud-itonami-isco-7532` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real cutter, workshop or operator data, credentials or operating
  documents.
- Keep production writes and disclosures behind CutCoordGovernor.
...
- Never widen the closed op-allowlist to include a
  pattern-cutting-execution-finalization op, a
